// lib/pages/plans_asaas/plans_asaas_widget.dart
...
import 'plans_asaas_model.dart';
export 'plans_asaas_model.dart';

class PlansAsaasWidget extends StatefulWidget {
  const PlansAsaasWidget({super.key});

  static String routeName = 'plans_asaas';
  static String routePath = '/plans_assas';

  @override
  State<PlansAsaasWidget> createState() => _PlansAsaasWidgetState();
}

class _PlansAsaasWidgetState extends State<PlansAsaasWidget> with TickerProviderStateMixin {
  late PlansAsaasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlansAsaasModel());
